...
public class TheatrePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Browse by Theatres");
        ...
        jRadioButton1.setText("Grand Theatres");
        ...
        jRadioButton3.setText("CinemaWorld");
        ...
        jRadioButton4.setText("Cineplex");
        ...
        jRadioButton5.setFont(new java.awt.Font("Serif", 0, 18)); // NOI18N
        jRadioButton5.setText("Galaxy Cinemas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TheatrePage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TheatrePage().setVisible(true);
            }
        });
    }
